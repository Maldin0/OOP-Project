...
public class MyFrame extends JFrame {
    ...
    public MyFrame() {
        ...
        p = new MusicPlayer();
        p.play("src/sound/Slimeconnector Music.wav");
        ...
        menuPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                // Background
                Image bgImage = new ImageIcon("src/image/BG01.png").getImage();
                g.drawImage(bgImage, 0, 0, null);
                Image slimeFront = new ImageIcon("src/image/Slime front.png").getImage();
        ...
        // Start Button;
        ImageIcon button1 = new ImageIcon("src/image/Start button.png");
        ...
        // ScoreBoard;
        ImageIcon button2 = new ImageIcon("src/image/Scoreboard button.png");
        ...
        // Credit;
        ImageIcon button3 = new ImageIcon("src/image/Credit button.png");
        ...
        // Exit;
        ImageIcon button4 = new ImageIcon("src/image/Exit button.png");
        exitBtn = new JButton();
        ...
        // How to Play;
        ImageIcon button5 = new ImageIcon("src/image/Help button.png");
        helpBtn = new JButton();
        ...
        // Sound Setting;
        soundBtn = new JButton(new ImageIcon("src/image/Sound button.png"));
        soundBtn.setBounds(80, 15, 50, 50);
        soundBtn.addActionListener(event);
        menuPanel.add(soundBtn);

        //  Logo
        logoName = new JLabel(new ImageIcon("src/image/Finished logo.png"));
        logoName.setBounds(40, 110, 250, 150);
        menuPanel.add(logoName);

        // Insert Icon Image
        ImageIcon icon2 = new ImageIcon("src/image/Slimeconnector_icon.png");
